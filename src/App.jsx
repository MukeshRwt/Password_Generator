...
} ,[length, numberAllowed, charAllowed, setPassword])    //usCallback
...
useEffect( ()=>{
  ...
  return (
    <>
      ...
      placeholder='passwoed' readOnly ref={passwordRef}
       />

       <button className='outline-none bg-blue-700 text-white 
       px-2.5 py-0.3 shrink-0 ' onClick={copyPasswordToClipBoard}>
        copy</button>
        </div>
